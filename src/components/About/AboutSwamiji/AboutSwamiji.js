...
const AboutSwamiji = () => {
        return (
          <div>           
            ...
            <img src="/images/Swamyji.jpg" alt="Swamiji" className={classes.Swamiji} />
        ...
        Swamy Sugunanda Gayathri is a Sidha Yogi. He went to Himalayas at the age of 13 at the behest  
         ...
         his dreams and in search of the aim of his life.
            ...
            Sadhana. Then, he went back to Himalayas and met Mata Renuka Devi in Gangothri.  
            ...
            him also. She blessed him for Akhanda Gayathri Maha Purascharana for 5000 years. After this, 
            Swamy Sugunanda Gayathri came back to Hyderabad and took Raja Yoga on July 8th, 2012.

             <img src="/images/kedarnath.jpg" alt="Kedarnath" className={classes.Image} />
            </div>

            <div className={classes.AboutSwamiji}>
              <img src="/images/gm2.jpg" alt="Gayathri Maha Purascharana" className={classes.Image} />

            On January 22nd, 2018, Swamy Sugunanda Gayathri started 24 years long Gayathri Maha Purascharana. 
            This yagna involves 24 Lakh Gayathri Mantra Jaap every year for 24 years.
            More on that in the Gayathri Maha Purascharana tab!
            </div>
            <BooksBySwamiji className={classes.BooksBySwamiji} />
            </div>
